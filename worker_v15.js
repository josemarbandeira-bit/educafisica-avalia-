    ...
    nav() + `
      <main class="dashboard-page">
        ...
        <section class="quick-actions">
          ...
          <a href="/caderno" class="quick-card rco-quick-card"><span class="quick-icon teal">▦</span><div><b>Caderno RCO</b><small>Turmas, trimestres e notas</small></div><i>›</i></a>
