...
async function createExam(request, env) {
    ...
    return page(
      ...
      `
        <div class="login">
          ...
          <p>Para criar a prova, selecione no mínimo 2 e no máximo 10 temas.</p>
  ...
  if (mode === 'manual') {
    ...
    if (ids.length) {
      ...
      if (Number(validManual?.c || 0) !== ids.length) {
        return page(
          'Seleção inválida',
          `
            <div class="login">
              <h2>Alguma questão não corresponde aos assuntos escolhidos.</h2>
              <p>Atualize a lista e faça a seleção novamente.</p>
