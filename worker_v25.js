  ...
  return page(
    ...
    nav() + `
      <main class="dashboard-v16 dashboard-v21">
        ...
        <section class="dash-hero v21-hero">
          <div>
            <span class="eyebrow white">EDUCAFÍSICA AVALIA</span>
            <h1>Painel do professor</h1>
            <p>Provas organizadas e desempenho por turma, sem excesso de informação.</p>
          </div>
        ...
        <section class="dash-primary-actions v21-primary-actions">
          <a href="/provas/nova"><span>✎</span><div><b>Criar prova</b><small>Nova avaliação</small></div></a>
          <a href="/caderno"><span>▦</span><div><b>Caderno RCO</b><small>Copiar notas</small></div></a>
          <a href="/banco"><span>▤</span><div><b>Questões</b><small>Banco e imagens</small></div></a>
          <a href="/resultados"><span>▥</span><div><b>Resultados</b><small>Detalhes das provas</small></div></a>
        </section>
